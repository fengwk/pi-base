...
/**
 * Disk-backed {@link Filesystem} using Node's file APIs. Paths are accepted
 * as-is; callers responsible for any cwd or jail/sandbox resolution should wrap
 * this with their own subclass.
 */
