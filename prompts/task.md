...
- Specialization: available subagents are injected into the system prompt inside `<available_subagents>...</available_subagents>`; choose the subagent whose description best matches the subtask, and use only those exact `<name>` values.
