...
- `{"path":"src/new-module.ts","content":"export const demo = 1;\n"}`
- `{"path":"src/config.ts","content":"export const config = { enabled: true };\n"}`
- `{"path":"src/config.ts","content":"export const config = { enabled: false };\n"}`
